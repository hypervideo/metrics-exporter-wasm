...
impl<C: Clock> ExponentialBackoff<C> {
    ...
    fn get_random_value_from_interval(randomization_factor: f64, random: f64, current_interval: Duration) -> Duration {
        ...
        match self.max_elapsed_time {
            ...
            _ => {
                ...
                let randomized_interval =
                    Self::get_random_value_from_interval(self.randomization_factor, random, self.current_interval);
